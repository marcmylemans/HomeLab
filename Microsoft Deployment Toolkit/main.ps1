...
$functionFiles = @("Setup-DomainController.ps1", "Wait-VMReady.ps1", "Join-Domain.ps1", "Rename-VM.ps1", "Set-MdtSetupOnVm.ps1", "New-VMFromTemplate.ps1", "Configure-VMNetwork.ps1", "Set-VMStaticIP.ps1")
...
# MDT Configuration
$mdtConfig = $config.mdt
Invoke-MdtSetupOnVm -VMName $mdtConfig.vmName -Credential $adminCredential -MDTDeploymentShareFolder $mdtConfig.MDTDeploymentShareFolder -MDTDeploymentShareName $mdtConfig.MDTDeploymentShareName -WDSRemoteInstallFolder $mdtConfig.WDSRemoteInstallFolder
